...
import { ArrowLeft, GraduationCap, Edit, BarChart2 } from 'lucide-react';

export default function RefineFeaturePage() {
  return (
      ...
      <main className="container mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Leverage AI to polish your work to perfection. These tools help you meet the highest academic standards with ease.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <ToolCard
            ...
            description="AI automatically rewrites your paper abstract in the style of specific journal reviewers or grant evaluators."
          />
          <ToolCard
            icon={<BarChart2 />}
