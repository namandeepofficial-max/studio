...
import { ArrowLeft, GraduationCap, Lightbulb, SearchCheck } from 'lucide-react';

export default function InnovateFeaturePage() {
  return (
      ...
      <main className="container mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Break new ground with AI tools designed to foster creativity and critical analysis in your research.
          </p>
        </div>
